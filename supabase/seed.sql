...
-- Version corrigée : ON CONFLICT DO NOTHING partout
-- =============================================
...
INSERT INTO roles_permissions (role_id, permission_id)
  SELECT '00000000-0000-0000-0000-000000000002', id FROM permissions WHERE module != 'administration'
ON CONFLICT DO NOTHING;

INSERT INTO roles_permissions (role_id, permission_id)
  SELECT '00000000-0000-0000-0000-000000000003', id FROM permissions WHERE action = 'lire'
ON CONFLICT DO NOTHING;
...
ON CONFLICT (famille_id, personne_id) DO NOTHING;
...
ON CONFLICT (formation_id, personne_id) DO NOTHING;
